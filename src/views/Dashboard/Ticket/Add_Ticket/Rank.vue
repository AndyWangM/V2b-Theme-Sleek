...
watch(pick,value => {
  emit('update:rank_index',Number(value))
})
</script>
<template>
  <div class="radio-inputs">
    <label>
      <input class="radio-input" id="a" type="radio" value="0" v-model="pick" name="engine">
      <span class="radio-tile">
					...
					<span class="radio-label">不太着急</span>
				</span>
    </label>
    <label>
      <input class="radio-input" id="b" type="radio" value="1" v-model="pick" name="engine">
      <span class="radio-tile">
				<span class="radio-icon">
				...
				<span class="radio-label">有点着急</span>
			</span>
    </label>
    <label>
      <input class="radio-input" id="c" type="radio" value="2" v-model="pick" name="engine">
      <span class="radio-tile">
				<span class="radio-icon">
				...
				<span class="radio-label">非常着急</span>
			</span>
    </label>
  </div>
</template>
